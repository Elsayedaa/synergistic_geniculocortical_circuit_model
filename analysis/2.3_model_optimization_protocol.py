...
model = SGCCircuit(param_bounds, enforce_permutation=P)
model.initialize_random_parameters(n_v1=Y_true.shape[0], n_lgn=3, n_sample=4000)
...
optimizer.save_state(os.path.join('c:\\', *os.getcwd().split('\\')[1:-1], 'project_datafiles', 'sgcc_mop_4_23_26'), write=True)